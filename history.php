...
<body>
    ...
    <!-- Konten -->
    <center><h1 class="mt-5">History Pembayaran Siswa</h1></center>
    <form action="" method="POST" autocomplete="off"><br>
        <br>
        Cari Siswa <input class="btn btn-dark text-light" type="text" name="nisn" placeholder="Cari berdasarkan NISN" autofocus>
        <button class="fa fa-search btn btn-info" type="submit" name="cari"></button>
    </form>
